...
class _AnimatedConnectionButtonState extends State<AnimatedConnectionButton>
  ...
  Color _getButtonColor() {
    if (widget.isConnected) {
      ...
      return const Color(0xFF6B7280); // 灰色，未连接状态
    }
  }

  Color _getButtonSecondaryColor() {
    if (widget.isConnected) {
      return AppTheme.successGreen.withOpacity(0.7);
    } else if (widget.isConnecting) {
      return AppTheme.primaryNeon;
    } else {
      return const Color(0xFF4B5563); // 深灰色，未连接状态的次要颜色
    }
  }
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  ...
                  if (widget.isConnected || widget.isConnecting)
                    BoxShadow(
                      color: _getButtonColor().withOpacity(0.4 * _glowAnimation.value),
